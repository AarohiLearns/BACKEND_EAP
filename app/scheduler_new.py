        ...
        try:
            ...
            for email in emails:
                ...
                try:
                    ...
                    # email[12] = status (not needed here, already filtered to Pending)
                    ...
                    if repeat_interval == "Never":
                        ...
                        # ---- CORE FIX: compute the real next time ----
                        ...
                        # ---- max_occurrences cap ----
                        # occurrence_count reflects how many times
                        # this chain has sent so far, INCLUDING the
                        # one that was just sent. If the user set a
                        # cap and we've hit it, stop here.
                        if max_occurrences is not None:

                            if max_occurrences <= 0:

                                # User error: 0 or negative means
                                # "no further sends allowed" --
                                # stop immediately, chain complete.
                                schedule_next = False
                                ...
                                print(
                                    ...
                                    "(To resume, edit this row's status "
